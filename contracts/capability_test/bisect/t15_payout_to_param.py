...
# T15 = T11 (known good) with EXACTLY ONE change: claim_refund() becomes
# payout_to(treasury) and emit_transfer goes to Address(treasury) instead of
# Address(sender). Isolates whether paying a parameter-supplied third party
# is what breaks schema loading.
...
class T15PayoutToParam(gl.Contract):
    ...
    @gl.public.write
    def payout_to(self, treasury: str) -> str:
        sender = gl.message.sender_address.as_hex
